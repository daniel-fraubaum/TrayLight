...
public partial class WelcomeWindow : Window
{
    ...
    public WelcomeWindow(WelcomeViewModel vm, IThemeService themeService)
    {
        InitializeComponent();
        DataContext = vm;
        ...
        {
            // Close on the dispatcher to be safe — even though the command is
            // already on the UI thread today, an event-based handshake keeps
            // the option to raise it from a background task open.
